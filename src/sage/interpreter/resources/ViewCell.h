...
protected:
	...
	AgiColor color;
	bool mirrored;
	std::vector<uint8_t> data; // NOTE: does this need to be 32 bit??
	//uint8_t** data;
	uint8_t mirroredLoopID;
public:
	ViewCell(AgiColor color, uint8_t width, uint8_t height, bool mirrored, std::vector<uint8_t> data, uint8_t mirroredLoopID);
